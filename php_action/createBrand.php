...
//create a array to pass the operation message to the format
$valid['success'] = array('success'=> false,'message'=>array());
//check if the form is submited and creates to variable to hold the brand name and status value and insert the information into the system
